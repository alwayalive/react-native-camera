...
public class RCTCamera {
    ...
    private static final Resolution RESOLUTION_288P = new Resolution(352, 288);
    ...
    public CamcorderProfile setCaptureVideoQuality(int cameraType, String captureQuality) {
        ...
        switch (captureQuality) {
            ...
            case RCTCameraModule.RCT_CAMERA_CAPTURE_QUALITY_HIGH:
                ...
                break;
            case RCTCameraModule.RCT_CAMERA_CAPTURE_QUALITY_288P:
                videoSize = getBestSize(supportedSizes, RESOLUTION_288P.width, RESOLUTION_288P.height);
                cm = CamcorderProfile.get(_cameraTypeToIndex.get(cameraType), CamcorderProfile.QUALITY_CIF);
                break;
            case RCTCameraModule.RCT_CAMERA_CAPTURE_QUALITY_480P:
